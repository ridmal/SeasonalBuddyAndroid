...
public abstract class StickerView extends FrameLayout{
   ...
   // static final String TAG = "TextFitTextView";
    ...
    private final static int BUTTON_SIZE_DP = 40;
    ...
    private void init(Context context){
       ...
       // this.iv_border = new BorderView(context);
        ...
        this.iv_ok.setImageResource(R.drawable.ok);
     ...
     //  int margin = convertDpToPixel(0, getContext());
        int size = convertDpToPixel(SELF_SIZE_DP, getContext());
      //  int size = convertDpToPixel(0, getContext());
...
//        iv_border_params.setMargins(margin,margin,margin,margin);
       ...
       this.addView(getMainView(), iv_main_params);
        //this.addView(getMainView());




//        getMainView().setOnTouchListener(new OnTouchListener() {
//            @Override
...
//    }
    ...
    public void setControlItemsHidden(boolean result){
        if(result) {
           // iv_border.setVisibility(View.INVISIBLE);
            iv_scale.setVisibility(View.INVISIBLE);
            iv_delete.setVisibility(View.INVISIBLE);
