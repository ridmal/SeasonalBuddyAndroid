...
//
//    // Mprivate static final String TAG = MainActivity.class.getSimpleName();
//
//    // Movies json url
//    private static final String url = "http://api.androidhive.info/json/movies.json";
//
//
//    static String urlcard = null;
...
//
//        cardbtn1 = (Button) findViewById(R.id.cardbtn);
//        clipbtn1 = (Button) findViewById(R.id.clipbtn);
//
...
//        cadapter = new CardAdapter(MainActivity.this, cardList, url);
...
//        JsonArrayRequest movieReq = new JsonArrayRequest(urlcard,
...
//        //adapter = new CustomListAdapter(this, movieList);
//        // cadapter = new CardAdapter(this, cardList);
//        clipadapter = new clipadapter(MainActivity.this, cardList, url);
...
//
//        final Dialog download = new Dialog(MainActivity.this);
...
//                //filepath.list();
//                File dir = new File(filepath + savelink);
